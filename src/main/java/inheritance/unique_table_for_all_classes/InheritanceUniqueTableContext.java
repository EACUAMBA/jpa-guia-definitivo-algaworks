...
public class InheritanceUniqueTableContext {
    ...
    public static void printingPerson(EntityManager entityManager){
        System.out.println("\nLooking for persons...");
        List<Person> people= entityManager.createQuery("select p from person_unique_table_for_all_classes p", Person.class).getResultList();
