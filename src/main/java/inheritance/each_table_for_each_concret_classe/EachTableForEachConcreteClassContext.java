...
public class EachTableForEachConcreteClassContext {
    ...
    public static void printingPerson(EntityManager entityManager){
        System.out.println("\nLooking for persons...");
        List<Person>  people = entityManager.createQuery("select p from person_each_table_for_each_concret_classe p", Person.class).getResultList();
