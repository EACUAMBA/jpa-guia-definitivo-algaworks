...
public class startChapterFour {
    ...
    public static void savingWith_OneToOne_Relationship(EntityManager entityManager){
        ...
        carList.stream().forEach(carInsuranced ->
                System.out.printf("%s%nDetails: %s%nStart date: %s%nEnd Date: %s", carInsuranced.getCarId(), carInsuranced.getInsuranceCar() != null ?  carInsuranced.getInsuranceCar().getDetails() : "" , carInsuranced.getInsuranceCar() != null ? car.getInsuranceCar().getStartDate().format(DateTimeFormatter.ofPattern("dd-MM-yyyy")) : "", carInsuranced.getInsuranceCar() != null ? car.getInsuranceCar().getEndDate().format(DateTimeFormatter.ofPattern("dd-MM-yyyy")) : ""));
...
//        System.out.printf("%s%nDetails: %s%nStart date: %s%nEnd Date: %s", carInsuranced.getCarId(), carInsuranced.getInsuranceCar().getDetails(), car.getInsuranceCar().getStartDate().format(DateTimeFormatter.ofPattern("dd-MM-yyyy")), car.getInsuranceCar().getEndDate().format(DateTimeFormatter.ofPattern("dd-MM-yyyy")));
    ...
    public static void savingLargFilesWithLobAnnotation(EntityManager entityManager) {
        ...
        especificacao.append("O Hummer H1 é um modelo civil baseado no \"M998 High Mobility Multipurpose Wheeled Vehicle\" (HMMWV), popularmente conhecido como Humvee, veículo militar desenvolvido pela AM General, o H1 posui quatro principais tipos: dois lugares com teto metal , quatro lugares com teto de lona, quatro lugares com teto de metal e quatro lugares com teto tipo perua.[1]");
